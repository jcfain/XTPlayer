...
mkdir XTPlayer-v0.32a_MacOS_x86_64
cp -R XTPlayer.app XTPlayer-v0.32a_MacOS_x86_64/
hdiutil create /tmp/tmp.dmg -ov -volname "XTPlayer-v0.32a_MacOS_x86_64" -fs HFS+ -srcfolder "XTPlayer-v0.32a_MacOS_x86_64"
hdiutil convert /tmp/tmp.dmg -format UDZO -o XTPlayer-v0.32a_MacOS_x86_64.dmg
