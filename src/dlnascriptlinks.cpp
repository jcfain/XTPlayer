...
void DLNAScriptLinks::setUpData()
{
    ...
    foreach (auto key, storedLinks.keys())
    {
        ...
        connect(browseButton, &QPushButton::clicked, this, [this, key]() {
            QString funscriptPath = QFileDialog::getOpenFileName(this, tr("Choose script for video: ") + key, SettingsHandler::mediaLibrarySettings.getLast(LibraryType::MAIN), "Script Files (*.funscript)");
