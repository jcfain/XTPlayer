...
targetDirectory=./Deploy/XTPlayer-v0.33a_Linux_x86_64
...
cqtdeployer -bin $xteBinDirectory clear -libDir $librDirectory -qmake $qmakeDirectory -targetDir $targetDirectory
...
cp $xteBinDirectory/lib* $targetDirectory/lib
